...
class KirimControllerEng extends Controller
{
    //
    //add Kirim
    ...
    {   
        ...
        return view('english.kirim_tugagan', compact('kirims', 'olchams', 'tovars'));
    }
    ...
    {   
        ...
        ->get();
        $olchams = Olchamlar::where('firmaid', $userId)->get();
        return view('english.kirim_bor', compact('kirims', 'olchams', 'tovars'));
    }
        ...
        public function kirim()
    {
        ...
        ->get();
        $olchams = Olchamlar::where('firmaid', $userId)->get();
        return view('english.kirim', compact('kirims', 'olchams', 'tovars'));
    }
    ...
    public function kirimscan()
    {
        ...
        ->get();
        $olchams = Olchamlar::where('firmaid', $userId)->get();
        return view('english.kirim_scan', compact('kirims', 'olchams', 'tovars'));
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return redirect()->route('adminkirimeng')->with('success', 'Deleted.');
        }
