...
class ChiqimsavdoControllerEng extends Controller
{
    //
     //add Kirim
     public function chiqimbugunson()
     {
        $user = auth()->user();
         ...
         return view('english.chiqim_bugun_son', compact('olchams', 'tovars', 'users', 'chiqim'));
     }
     ...
     $users = User::where('firmaid', $userId)->orwhere('id', $userId)->get();
         $chiqim = Chiqimsavdo::where('firmaid', $userId)->where('sotildi', 1)->whereDate('created_at', $today)->get();
         return view('english.chiqim_bugun', compact('olchams', 'tovars', 'users', 'chiqim'));
     }
     ...
     {  
        ...
        $kirims = Kirim::where('firmaid', $userId)->where('muddati', '>', now())->orderBy('muddati', 'desc')->get();
         ...
         return view('english.chiqim', compact('kirims', 'olchams', 'tovars', 'chiqims', 'chiqim'));
     }

     public function chiqimsana(){
        return view('english.chiqimsana');        
     }

     public function chiqimsanason(){
        return view('english.chiqimsana_son');        
     }
     ...
     public function sotildi()
     {
        ...
        if($user->type == 'admin'){
         ...
         return redirect()->route('adminchiqimeng')->with('success', 'Sold.');
     }
     ...
     public function delete(Request $request, $id)
     {
         ...
         // Redirect back with a success message
         return redirect()->route('adminchiqimeng')->with('success', 'Deleted.');
         }
     ...
     public function chiqimsanaqidir(Request $request)
     {
        ...
        ->get();
         ...
         $olchams = Olchamlar::where('firmaid', $userId)->get();
         $users = User::where('firmaid', $userId)->orwhere('id', $userId)->get();
         return view('english.chiqimsanashow', compact('users', 'olchams', 'tovars', 'chiqim'));
     }
     ...
     public function chiqimsanaqidirson(Request $request)
     {
        ...
        ->get();
         ...
         $olchams = Olchamlar::where('firmaid', $userId)->get();
         $users = User::where('firmaid', $userId)->orwhere('id', $userId)->get();
         return view('english.chiqimsanashowson', compact('users', 'olchams', 'tovars', 'chiqim'));
     }
     ...
     public function qaytar($id)
     {
         ...
         // Redirect back with a success message
         return redirect()->route('adminchiqimeng')->with('success', 'Successfully Saved');    
     }
}
