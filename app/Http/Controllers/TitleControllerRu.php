...
class TitleControllerRu extends Controller
{
    //add Title
    public function title()
    {
        ...
        return view('russian.title', compact('titles'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('russian.titledit', compact('titles', 'title2'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admintitleru')->with('success', 'Сохранено успешно!');    
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        // Redirect back with a success message
        return redirect()->route('admintitleru')->with('success', 'Удалено!');
        }
