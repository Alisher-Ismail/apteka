...
class OlchamlarControllerEng extends Controller
{
     //add Olchamlar
     ...
     {   
        $user2 = auth()->user();
         ...
         return view('english.olcham', compact('olchams'));
     }
     ...
     public function edit($id)
     {
         ...
         return view('english.olchamedit', compact('olchams', 'olcham'));
     }
     ...
     public function update(Request $request, $id)
     {
         ...
         return redirect()->route('adminolchameng')->with('success', 'Successfully Saved.');    }
     ...
     public function delete(Request $request, $id)
     {
         ...
         // Redirect back with a success message
         return redirect()->route('adminolchameng')->with('success', 'Deleted.');
         }
