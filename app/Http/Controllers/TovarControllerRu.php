...
class TovarControllerRu extends Controller
{   
...
{   
    ...
    if ($count == 0) {
        ...
        return response()->json('Этот штрих-код уже был введен!');
    }
}
    ...
    {   
        ...
        return view('russian.tovar', compact('tovars', 'olchams'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('russian.tovaredit', compact('tovars', 'tovar', 'olchams'));
    }
    ...
    //    else{
            ...
            return redirect()->route('admintovarru')->with('success', 'Сохранено успешно.');
      //  }
    ...
    public function delete(Request $request, $id)
    {
        ...
        // Redirect back with a success message
        return redirect()->route('admintovarru')->with('success', 'Удалено');
        }
        ...
        public function store(Request $request)
{
    ...
    try {
        ...
        if($tovarchek){
            return redirect()->back()->withErrors(['error' => 'Этот штрих-код уже внесен в базу данных.']);
        }
        else{
