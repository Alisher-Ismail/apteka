...
<div class="card mb-4">
        ...
        @endif
            ...
            <form method="post" action="{{ route('olcham.storeru') }}" id="add-form" enctype="multipart/form-data">
                @csrf <!-- CSRF token -->
                <div class="mb-3">
                    <label for="Olcham Nomi">Единица измерения</label>
                    <input type="text" class="form-control" id="olcham_nomi" name="olcham_nomi" placeholder="Введите единицу измерения" required>
                </div>
