...
<div class="container-fluid px-4">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('olcham.updateeng', $olchams->id) }}" id="add-form" enctype="multipart/form-data">
                @csrf <!-- CSRF token -->
                <div class="mb-3">
                    <label for="Olcham">Measurement Name</label>
                    <input type="text" class="form-control" id="olcham_nomi" name="olcham_nomi" placeholder="Enter Measurement Name" value="{{ old('olcham_nomi', $olchams->olcham_nomi ?? '') }}" required>
                </div>
